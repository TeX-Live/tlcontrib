...
% placed on the same page where they are to appear
\placeQuesLayer{%
  \begin{textblock*}{2.25in}[0,0](2.5in+.725in,2.5in\ifeqforpaper+.5in\fi) %,+1in
  \insertQuesLayer{#1}
  \end{textblock*}%
}
...
\centering
\leavevmode\kern3pt\parbox{\linewidth}{\insertSideshow{2}{3}[width=.24\linewidth]{flowers2/rose}}

\vfill

\placeMessageField{\linewidth}{8\baselineskip}
\end{minipage}}%
%
