...
\screensize{9in}{8.5in} % height, width
...
\fmtOCGQues{%
  ...
  \parbox{\linewidth}{\textcolor{white}{%
  \parbox{\linewidth}{\dpsQuesLayer{#1}\vskip3pt}}}}%
}

% these are placed on the page where they are to appear
\placeQuesLayer{%
  \begin{textblock*}{2.25in}[0,0](2.5in+.725in,3.6in)
  \insertQuesLayer{#1}
  \end{textblock*}%
}
\placeOtherLayer{%
  \begin{textblock*}{2.25in}[0,0](2.5in+.725in,3.6in)\centering
...
\vfill
\begin{center}
\placeMessageField{0.8\linewidth}{8\baselineskip}
\end{center}
\end{minipage}}%
%
