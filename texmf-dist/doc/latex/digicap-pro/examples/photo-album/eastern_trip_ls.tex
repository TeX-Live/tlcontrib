...
\setScreensizeFromGraphic[width=5.5in]{./digis/100_0141}
...
\def\myfmt{\bfseries\scriptsize}
\PicsThisDoc
{%
    {p1}{./digis/100_0031}{Gettysburg Battlefield: Seminary Ridge}
        {\myfmt This shot was taken from seminary
...
% we use rollovers for the captions
\useRollovers
...
\insertThumbs{7}{2}
\end{minipage}\hfil
\begin{minipage}[t]{.7\linewidth}\centering
